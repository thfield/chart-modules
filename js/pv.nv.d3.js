    ...
    */
  	...
  	function layer(selection) {
        ...
        function mouseHandler() {
          ...
          /* If mouseX/Y is outside of the chart's bounds, trigger a mouseOut event. */
    ...
    function chart(selection) {
      selection.each(function(data) {
        ...
        if (showXAxis) {
            ...
            if(rotateLabels) {
              switch(rotateLabels) { //tyler's attempt to prettify rotation
              case -45:
                xTicks
                .selectAll('.tick text')
                //.attr('transform', function(d,i,j) { return 'translate('+  -x.rangeBand()/2  +')rotate(-45 0,0)' })
                .attr('transform', function(d,i,j) { return 'translate('+  -6  +')rotate(-45 0,0)' }) //6 is half of default label fontsize
                .style('text-anchor', 'end');
                break;
              case 45:
                xTicks
